...
ALIAPY_CONFIG = {
    ...
    "sign_type": "RSA2",
    "debug": False,
    "return_url": "http://www.adcwb.com/payments/result",  # 同步回调地址
    "notify_url": "http://api.adcwb.com/payments/result/",  # 异步结果通知
}
...
CACHES = {
    ...
    "default": {
        ...
        # 项目上线时,需要调整这里的路径
        "LOCATION": "redis://106.14.213.94:6379/0",
    ...
    "session": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://106.14.213.94:6379/1",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    ...
    "sms_code": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://106.14.213.94:6379/2",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    ...
    "cart": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://106.14.213.94:6379/3",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    }
